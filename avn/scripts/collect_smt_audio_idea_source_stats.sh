...
MANIFEST="${REPO_ROOT}/avn/manifests/idea_source/smt_audio_${SOURCE_SETTING}_sample_seed${SEED}.json"
OUTPUT="${REPO_ROOT}/avn/results/idea_source_statistics/smt_audio_${SOURCE_SETTING}_sample_seed${SEED}.json"
...
python3 ss_baselines/savi/run.py --run-type eval --exp-config "${CONFIG}" \
  --model-dir "${REPO_ROOT}/avn/results/idea_source_statistics/smt_audio_${SOURCE_SETTING}_sample_runtime" \
