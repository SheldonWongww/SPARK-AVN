...
class AudioCNN(nn.Module):
    ...
    def forward(self, observations):
        ...
        while audio_observations.dim() > 4:
            if audio_observations.size(-1) == 1:
                audio_observations = audio_observations.squeeze(-1)
            elif audio_observations.size(0) == 1:
                audio_observations = audio_observations.squeeze(0)
            else:
                break
