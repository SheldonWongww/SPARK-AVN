...
import soundspaces
import ss_baselines.common.tta_adapter  # register TTAAudioNav dataset/task
# Explicitly import av_nav package to ensure trainer registration. Some
# installs (editable / site-packages mismatch) may silently skip running
# av_nav/__init__.py, so we re-import the trainer modules directly.
from ss_baselines.av_nav.ppo.ppo_trainer import PPOTrainer as _AVNavPPOTrainer  # noqa: F401
from ss_baselines.av_nav.ddppo.ddppo_trainer import DDPPOTrainer as _AVNavDDPPOTrainer  # noqa: F401
