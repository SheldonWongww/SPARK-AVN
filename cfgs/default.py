...
_C = CN()
_C.SEED = 0
_C.BASE_TASK_CONFIG_PATH = "cfgs/av_nav/single_source.yaml"
_C.TASK_CONFIG = CN()  # task_config will be stored as a config node
_C.CMD_TRAILING_OPTS = []  # store command line options as list of strings
_C.TRAINER_NAME = "base_ddppo"
...
_C.VIDEO_DIR = "video"
_C.TEST_EPISODE_COUNT = 100
_C.EVAL_CKPT_PATH_DIR = "ckpts"
_C.NUM_PROCESSES = 10
_C.SENSORS = ["RGB_SENSOR", "DEPTH_SENSOR"]
_C.CHECKPOINT_FOLDER = "ckpts"
_C.MODEL_DIR = "data/results"
_C.NUM_UPDATES = 1500
_C.NUM_UPDATES_PER_DOMAIN = 150
_C.LOG_INTERVAL = 10
...
_C.RL.PPO.entropy_coef = 0.05
_C.RL.PPO.lr = 1e-5
_C.RL.PPO.eps = 1e-5
_C.RL.PPO.max_grad_norm = 0.5
_C.RL.PPO.num_steps = 160
...
_C.RL.PPO.policy_type = 'msmt'
_C.RL.PPO.use_external_memory = True
...
_C.RL.PPO.SCENE_MEMORY_TRANSFORMER.hidden_size = 256
...
_C.RL.PPO.SCENE_MEMORY_TRANSFORMER.use_pretrained = True
_C.RL.PPO.SCENE_MEMORY_TRANSFORMER.pretrained_path = ''
_C.RL.PPO.SCENE_MEMORY_TRANSFORMER.actor_critic_pretrained_path = "-1"
...
_C.RL.DDPPO.backbone = "custom_resnet18"
_C.RL.DDPPO.pretrained_weights = ""
# Loads pretrained weights
_C.RL.DDPPO.pretrained = False
# Whether or not to reset the critic linear layer
_C.RL.DDPPO.reset_critic = False

# -----------------------------------------------------------------------------
# CONTINUAL LEARNING METHOD CONFIG
# -----------------------------------------------------------------------------
_C.CL_METHOD = CN()
_C.CL_METHOD.TYPE = "finetune"

# -----------------------------------------------------------------------------
# SPARK-AVN CONFIG
# -----------------------------------------------------------------------------
_C.CL_METHOD.SPARK_AVN = CN()
_C.CL_METHOD.SPARK_AVN.POOL_SIZE = 5
_C.CL_METHOD.SPARK_AVN.ROUTER_EMA_MOMENTUM = 0.95
_C.CL_METHOD.SPARK_AVN.ROUTER_TEMPERATURE = 1.0
_C.CL_METHOD.SPARK_AVN.EVAL_ROUTING_MODE = "top1" # "dense", "top1"
_C.CL_METHOD.SPARK_AVN.EVAL_TAG = ""
_C.CL_METHOD.SPARK_AVN.PROTOTYPE_BANK_SIZE = 5
_C.CL_METHOD.SPARK_AVN.EVAL_WARMUP_STEPS = 10
_C.CL_METHOD.SPARK_AVN.MAX_KMEANS_ITERS = 10
_C.CL_METHOD.SPARK_AVN.MERGE_W_VALUE = 0.5
_C.CL_METHOD.SPARK_AVN.MERGE_W_HHI = 0.25
...
_TC.DATASET.CONTENT_SCENES = [
    "q9vSo1VnCiC", "ac26ZMwG7aT", "PuKPg4mmafe", "r47D5H71a5s", 
    "jh4fc5c5qoQ", "S9hNv5qa7GM", "QUCTc6BB5sX", "VLzqgDo317F", 
    "5ZKStnWn8Zo", "EDJbREhghzL", "qoiz87JEwZ2", "VVfe2KiqLaN", 
    "vyrNrziPKCB", "b8cTxDM8gDG", "e9zR4mvMWw7", "kEZ7cmS4wCh", 
    "V2XKFyX4ASd", "gTV8FGcVJC9", "oLBMNvg9in8", "gYvKGZ5eRqb"
]
# -----------------------------------------------------------------------------
...
def get_config(
    ...
    actor_critic_path: Optional[str] = "-1",
) -> CN:
    ...
    config.CHECKPOINT_FOLDER = os.path.join(config.MODEL_DIR, 'ckpts')
    config.VIDEO_DIR = os.path.join(config.MODEL_DIR, 'video')
    config.LOG_FILE = os.path.join(config.MODEL_DIR, 'train.log')
    config.EVAL_CKPT_PATH_DIR = os.path.join(config.MODEL_DIR, 'ckpts')
