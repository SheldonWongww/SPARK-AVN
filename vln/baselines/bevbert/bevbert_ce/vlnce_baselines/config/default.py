...
_C.EVAL.EPISODE_ORDER_MANIFEST = ""
...
_C.INFERENCE.EPISODE_ORDER_MANIFEST = ""
...
# -----------------------------------------------------------------------------
# BEVBert adapts its graph/BEV fusion decision stack, never waypoint sensing or
# Habitat's low-level controller.
